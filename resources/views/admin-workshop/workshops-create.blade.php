<x-admin-layout>
<div class="pt-4">
    <h1 class="text-3xl font-bold mb-4 pl-4">Upload Workshop</h1>

    <form action="{{ route('workshops.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-lg">
    @csrf

...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="bg-white shadow-lg rounded-xl overflow-hidden">
        ...
        <div class="pl-4 pb-4">
            <a href="{{ route('filament.admin.resources.workshops.edit', $workshop->id) }}" class="inline-block px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 transition">
                Edit Workshop
            </a>
        </div>
        ...
        <div class="p-6 pt-0">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors text-sm flex items-center">
            ...
            @if($workshop->meets->count() > 0)
                <div class="grid grid-cols-1 gap-4">
                    @foreach($workshop->meets as $meet)
                        <a href="" class="block bg-white border border-gray-200 shadow rounded-lg p-4 hover:bg-gray-50 transition">
        ...
        <div class="p-6 pt-0">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="" class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors text-sm flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
                    Add Assignment

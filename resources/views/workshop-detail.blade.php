        ...
        <div class="flex flex-col items-center px-4 py-10 md:flex-row md:px-10 md:pt-10 md:pb-16">
            ...
            <div class="flex flex-col ps-0 md:ps-16 py-3 w-full h-auto md:h-auto mt-6 md:mt-0">
                ...
                <div class="text-center md:text-left mb-4">
                    <p class="font-medium">Biaya Pendaftaran:
                        <span class="text-">
                            @if ($workshop['price'] == 0)
                                Gratis
                            @else
                ...
                <div class="flex justify-center md:justify-start mb-4">
                    @if (auth()->check())
                        ...
                        @else
                            @if (auth()->user()->registrations()->where('workshop_id', $workshop->id)->where('courseStatus', 'finished')->exists())
                                <a href="{{ $workshop->certificateUrl }}"
                                    class="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-md transition-all">Download
                                    Sertifikat Anda</a>
                            @endif
                        @endif
                    @else
                                            ...
                                            <div
                                                ...
                                                <div class="p-6">
                                                    ...
                                                    <div class="flex items-center text-sm text-gray-500 mb-4">
                                                        ...
                                                        <span>tenggat : {{ $assignment->due_dateTime }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                ...
                <form action="{{ route('registerToWorkshop') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-end space-x-4">
                        <button type="button" id="cancelButton"
                            class="bg-gray-300 hover:bg-gray-400 px-4 py-2 rounded-md transition-all"

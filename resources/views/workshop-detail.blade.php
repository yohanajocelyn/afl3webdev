<x-layout>
    <section class="bg-gray-100 flex flex-col">
        ...
        <div class="flex justify-start space-x-6 mb-6">
            <button id="meetsButton" class="border-2 border-blue-500 text-blue-500 px-6 py-2 rounded-full hover:bg-blue-500 hover:text-white" onclick="toggleSection('meets')">
                Meets
            </button>
